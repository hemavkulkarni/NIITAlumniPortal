					...
					<c1:if
						...
						<li class="dropdown"><a class="dropdown-toggle"
							data-toggle="dropdown" href="#">JOB OPPORTUNITY <span
								class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value='/JobView'/>">VIEW ALL JOB
										OPPORTUNITY</a></li>
							</ul></li>
						<li class="dropdown"><a class="dropdown-toggle"
					...
					<c1:if
						...
						<li class="dropdown"><a class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								<li><a href="<c:url value='/BlogAdd'/>">ADD NEW BLOG</a></li>
								<li><a href="<c:url value='/BlogView'/>">VIEW ALL BLOG</a></li>
								<li><a href="<c:url value='/admin/blogViewApprove'/>">APPROVE
										BLOG</a></li>
							</ul></li>
						<li class="dropdown"><a class="dropdown-toggle"
							data-toggle="dropdown" href="#">BULLETINE <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value='/BulletineAdd'/>">ADD NEW
										BULLETINE</a></li>
								<li><a href="<c:url value='/BulletineView'/>">VIEW ALL
										BULLETINE</a></li>
							</ul></li>
						<li class="dropdown"><a class="dropdown-toggle"
							data-toggle="dropdown" href="#">JOB OPPORTUNITIES <span
								class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value='/JobAdd'/>">ADD NEW JOB
										OPPORTUNITIES </a></li>
								<li><a href="<c:url value='/JobView'/>">VIEW ALL JOB
										OPPORTUNITIES </a></li>
							</ul></li>
						<li class="dropdown"><a class="dropdown-toggle"
							data-toggle="dropdown" href="#">WHAT'S NEW <span
								class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="<c:url value='/WhatNewAdd'/>">ADD NEW
										WHAT'S NEW</a></li>
								<li><a href="<c:url value='/WhatNewView'/>">VIEW ALL
										WHAT'S NEW</a></li>
							</ul></li>
